<template>
    <div class="bg-white">
        ...
        <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            ...
            <p class="mx-auto mt-6 max-w-xl text-pretty text-lg/8 text-gray-300">Whether you need seamless gutter installation, professional cleaning, or repairs, The Gutters Green is here to provide reliable and customer-focused solutions. Get in touch today for a free quote!</p>
            ...
            <a href="/blog" class="text-sm/6 font-semibold text-white">Learn more <span aria-hidden="true">→</span></a>
            </div>
