...
const props = withDefaults(defineProps<{ title?: string, description?: string, headline?: string, image?: string, imageAlt?: string }>(), {
  title: 'The Gutters Green',
  description: 'Seamless Gutter Installation',
  headline: 'headline',
  image: '/images/gutters-laying.jpg',
  imageAlt: 'Freshly cut gutters arrayed in order to be installed.'
})
