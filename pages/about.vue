      ...
      <div class="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        <div class="lg:pr-4">
          <div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
            <h2 class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">My Story</h2>
            <p class="mt-8">My journey in the gutter industry began in 2012 when I worked for a leading gutter material supplier. This role allowed me to become well-versed in all aspects of gutter components, accessories, and terminology. More importantly, it introduced me to the skilled professionals who make up the backbone of this industry—the gutter installers.</p>
            <p class="mt-8">In 2015, I joined a prestigious gutter and roof cleaning company, where I received advanced fall protection training, a skill set that has been foundational throughout my career. It was during this time that I discovered my passion for delivering more than just a service—I enjoyed creating a memorable and positive experience for every customer.</p>
            <p class="mt-8">A few years later, I transitioned to the gutter division of a respected roofing company. My proficiency with ropes and ladders quickly set me apart, and I was entrusted with my own truck, gutter machine, and crew to manage. This position also reconnected me with many industry professionals as we regularly crossed paths while sourcing materials.</p>
            <p class="mt-8">In the years that followed, I ventured into building something of my own. I was fortunate to work with various construction and gutter companies, often through friends who valued my expertise. These collaborations gave me firsthand exposure to the approaches of both seasoned veterans and ambitious startups in the gutter industry.</p>

            <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">Today</h2>
